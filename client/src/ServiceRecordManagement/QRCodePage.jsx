...
function QRCodePage() {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', marginBottom: '1.5rem', color:'#fff', marginTop: '70px',fontSize: '2.5rem', fontWeight: 'bold', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.7)' }}>QR Codes</h2>
